...
/*
contract Address: 0xF0808B8876629FF403C61dbE2F3F692c5c470B37 this is binance testnet contract
 * totalSupply is distributed between two addresses and supply of one address has been locked till 2023.
*/
...
contract Pausable is Ownable {
  ...
  contract LockedWallets is Context {
    ...
    address internal constant lockedWallet = 0x34CE43c9a4D6726C51F0461FE9E86faE6e3d5EBC; 
    uint256 internal constant _releaseTime = 1624802150;
...
contract TreeLifeCoin is Context, IBEP20, Ownable, Pausable, LockedWallets {
  ...
  constructor() public {
    ...
    emit Transfer(address(0), lockedWallet, lockedSupply);
  }
  ...
  */
   ...
   */
  function transfer(address recipient, uint256 amount) external notLockedWallet whenNotPaused returns (bool) {
